...
namespace Microsoft.BotBuilderSamples
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<Translator>(sp => {

                var tr = new Translator(
                
                    Configuration.GetSection("Translator").GetValue<string>("TranslatorUri"),
                    Configuration.GetSection("Translator").GetValue<string>("CognitiveServicesTokenUri"),
                    Configuration.GetSection("Translator").GetValue<string>("SubscriptionKey")
                );
                 return tr;
            });

            services.AddSingleton<Sentiments>(sp => {

                var st = new Sentiments(

                    Configuration.GetSection("Sentiment").GetValue<string>("SentimentUri"),
                    Configuration.GetSection("Sentiment").GetValue<string>("SubscriptionKey")
                );
                return st;
            });
            ...
            services.AddSingleton(sp =>
            {
                ...
                var luisApp = new LuisApplication(
                    Configuration.GetSection("LUIS").GetValue<string>("App"), //LUIS APP
                    Configuration.GetSection("LUIS").GetValue<string>("ServiceKey"), //LUIS Service Key
                    Configuration.GetSection("LUIS").GetValue<string>("Url"));
